    ...
    render: function() {
        ...
        return (
            <div>
                ...
                <a href="#" onClick={() => this.props.changeAppMode('read')} className="btn btn-primary margin-bottom-1em">Read Products</a>
                ...
                <form onSubmit={this.onSave}>
                    <table className='table table-bordered table-hover'>
                        ...
                        <tr>
                            <td>Category</td>
                            <td>
                                <select className="form-control" onChange={this.onCategoryChange} value={this.state.selectedCategoryId}>
    ...
    render: function() {
        return (
            <tr>
                ...
                <td>
                    <a href="#" onClick={() => this.props.changeAppMode('readOne', this.props.product.id)} className="btn btn-info margin-right-1em">Read</a>
                    <a href="#" onClick={() => this.props.changeAppMode('update', this.props.product.id)} className="btn btn-primary margin-right-1em">Edit</a>
                    <a href="#" onClick={() => this.props.changeAppMode('delete', this.props.product.id)} className="btn btn-danger">Delete</a>
                </td>
            </tr>
        );
    }
...
// Component that contains the functionalities that appear on top of the products table: create product
...
var ReadOneProductComponent = React.createClass({
    ...
    // Show single product data in a table
    render: function() {
        return (
            <div>
                <a href='#'
...
var ReadProductsComponent = React.createClass({
    ...
    // On mount, fetch all products and store them as this component's state
    componentDidMount: function() {
                    ...
                    <table className="table table-bordered table-hover">
                        <tbody>
                            ...
                            <tr>
                                <td>Description</td>
                                <td>
                                    <textarea className="form-control" required value={this.state.description} onChange={this.onDescriptionChange}></textarea>
                                </td>
                            </tr>
                            <tr>
                                <td>Price ($)</td>
            ...
            <div className="row">
                ...
                <div className="col-md-6">
                    <div className="panel panel-default">
                        <div className="panel-body text-center">Are you sure?</div>
                        <div className="panel-footer clearfix">
                            <div className="text-center">
                                <button onClick={this.onDelete} className="btn btn-danger margin-right-1em">Yes</button>
